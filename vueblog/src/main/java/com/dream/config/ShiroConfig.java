...
import com.dream.shiro.JWTFilter;
import com.dream.shiro.MyRealm;
...
//        firstRealm.setCachingEnabled(true);//开启全局的缓存管理
       ...
       /* myRealm.setAuthenticationCacheName("authenticationCache");//设置缓存名称--认证
        myRealm.setAuthorizationCacheName("authorizationCache");//设置缓存名称--授权
    ...
    public DefaultWebSecurityManager securityManager() {
        DefaultWebSecurityManager securityManager = new DefaultWebSecurityManager(getRealm());
